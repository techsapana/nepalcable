...
export default function AdminTeam() {
  ...
  const handleSubmit = async () => {
    ...
    if (!form.post.trim()) return alert("Enter post");
        ...
        <div className="border-2 border-gray-300 p-8 rounded-xl shadow mb-10">
          ...
          <div className="flex gap-4 mt-6">
            <button
              ...
              disabled={submitting}
              className="bg-blue-600 hover:bg-blue-700 disabled:cursor-not-allowed cursor-pointer text-white px-6 py-3 rounded font-semibold"
            >
              {selected
                ? submitting
                  ? "Updating..."
